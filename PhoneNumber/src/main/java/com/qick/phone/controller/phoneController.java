...
public class phoneController {
	...
	@RequestMapping(value = "/{cDelete}", method=RequestMethod.DELETE)
	public @ResponseBody Response deleteContact(@PathVariable ("cDelete") String cDelete) {
		...
		try {
			...
			result = contactInfoService.deleteContact(cDelete);
		}
		catch(Exception e) {
			e.printStackTrace();
			Response response = new Response();
